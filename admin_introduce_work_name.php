        ...
        <div class="main_right_area">
            <div class="left_area">
                <div class="insert_write_area">
                    <a href="admin_introduce_write.php"><input type="button" class="insert_button" value="INSERT"></a>
                </div>
                    <?php
                    ...
                    if ($all = $db->query($sql)) {
                        while ($each = $all->fetch_assoc()) {
                            ...
                            <div class="main_left_table">
                                <a class="a_link_color_black" href="admin_introduce_work_name.php?year=<?=$year?>">
                                    <div class="left_table_title_box"><?= $year ?></div></a>
                            ...
                            <!--<div class="main_left_table">
                        <div class="table_data_box">
                            <div class="text_box_explain">작업 목록</div>
                        </div>
            ...
            <div class="right_area">
                <div class="insert_write_area">
                    ...
                    <div class="right_area_button">
                        ...
                        $work_name_ = ['work_name_1', 'work_name_2', 'work_name_3', 'work_name_4', 'work_name_5'];
                        ...
                        for ($a = 0;$a < 5; $a++) {
                        /*$work_name_[$a] = $each[$work_name_[$a]];*/


                        ?>
                        <a href="admin_introduce_modify.php?year=<?= $year ?>&work_name_1=<?= $work_name_[0] ?>&work_name_2=<?= $work_name_[1] ?>&work_name_3=<?= $work_name_[2] ?>&work_name_4=<?= $work_name_[3] ?>&work_name_5=<?= $work_name_[4] ?>">
                            ...
                            ?>
                            <input type="button" class="modify_button" value="MODIFY"></a>
                    </div>
                </div>
