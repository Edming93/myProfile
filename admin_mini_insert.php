...
<div class="main">
    ...
    <div class="main_right">
        <div class="right_header_top">
            ...
            <div class="small_title">_ SMALL_TITLE_INSERT</div>
        </div>

        <div class="main_right_area">
            <form method="post" action="admin_db_mini_insert.php">
                <div class="main_table_no_height">
                    <div class="table_title_box">MAIN_TITLE</div>

                    <div class="table_data_box_area">
                        <?php
                        $get_main_title = $_GET['main_title'];
                        ?>
                        <input class="text_box_year" type="text" name="main_title" value="<?= $get_main_title ?>" readonly>
                        <div class="text_box_explain_area">
                            <div class="text_box_explain">앨범명</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="main_table_no_height">
                    ...
                    <div class="table_data_box_area">
                        ...
                        $get_year = $_GET['year'];
                        ?>
                        <input class="text_box_year" type="text" name="year" value="<?= $get_year ?>" readonly>
                        <div class="text_box_explain_area">
                ...
                <div class="album_big_title">

                    <div class="main_table_no_height">
                        <div class="table_title_box">SMALL_TITLE</div>
                        <div class="table_data_box_area">
                            <?php
                            $get_name_ =['get_name_1','get_name_2','get_name_3','get_name_4','get_name_5'];

                            $mini_work_name_= ['mini_work_name_1','mini_work_name_2','mini_work_name_3','mini_work_name_4','mini_work_name_5'];

                            $a=0;

                            for ($a;$a<5;$a++) {
                                $get_name_[$a]=$_GET[$get_name_[$a]];

                                ?>
                                <div class="table_data_box">
                                    <input class="text_box_year" type="text" name="<?=$mini_work_name_[$a]?>" value="<?=$get_name_[$a]?>">
                                    <div class="text_box_explain_area">
                                        <!--<input class="plus_button" type="button" value="+" onclick="plus_button();"/>-->
                                        <div class="text_box_explain">소제목을 입력</div>
                                    </div>
                                </div>
                                <?php
                            }
